...
export default function AddCustomerForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white border border-walnut/10 rounded-xl p-6 mb-7">
      <h2 className="font-display text-lg text-walnut mb-4">Add a new customer</h2>
      ...
      <p className="text-xs text-walnut/50 mt-2">
