...
export default function AddCustomerForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white border border-black/10 rounded-xl p-6 mb-7">
      <h2 className="font-display text-lg text-black mb-4">Add a new customer</h2>
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-black/15 rounded-md text-sm"
          />
        </div>
        <div>
