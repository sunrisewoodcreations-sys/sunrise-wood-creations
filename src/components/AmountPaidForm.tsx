...
export default function AmountPaidForm({
  ...
  return (
    <form onSubmit={handleSave} className="bg-cream border border-walnut/10 rounded-lg p-4 mt-4">
      <div className="grid grid-cols-3 gap-4 mb-3 text-sm">
        <div>
          <div className="text-walnut/50 text-xs mb-1">Total</div>
          <div className="font-semibold text-walnut">${total.toFixed(2)}</div>
        </div>
        <div>
          <div className="text-walnut/50 text-xs mb-1">Amount paid</div>
          <div className="flex items-center gap-1">
            ...
            <input
              ...
              className="w-24 border border-walnut/15 rounded-md px-2 py-1 text-sm"
            />
          </div>
        </div>
        <div>
          <div className="text-walnut/50 text-xs mb-1">Still owed</div>
      ...
      <button
        type="submit"
        disabled={loading}
        className="bg-walnut text-white px-4 py-1.5 rounded-md text-xs font-semibold disabled:opacity-60"
      >
